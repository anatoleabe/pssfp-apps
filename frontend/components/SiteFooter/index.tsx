      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-12 md:grid-cols-2 lg:grid-cols-4">
        ...
        <section aria-labelledby="footer-nav-heading">
          ...
          <ul className="mt-3 space-y-2 text-sm">
            ...
            <li><Link href="/pssfp" className="inline-block py-1 text-[#333] hover:text-[#6B2FA0] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6B2FA0] focus-visible:ring-offset-2 rounded dark:text-[#F5EFE3] dark:hover:text-[#B084E8] dark:focus-visible:ring-[#E8C868]">{tNav('pssfp')}</Link></li>

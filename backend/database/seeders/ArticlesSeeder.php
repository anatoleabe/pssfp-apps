 ...
 * (`is_pinned=true`) et apparaissent sur la home. Les 4 sont `published`
 * pour le go-live (LOT D.2 — Centre Pasteur et Assemblée Nationale inclus).
 *
    ...
    private function newArticles(): array
    {
        return [
            ...
            [
                ...
                'excerpt' => 'Les candidatures pour la 14e promotion du Master Professionnel en Finances Publiques sont ouvertes. Date limite : 18 septembre 2026, 15h30.',
                'body' => "## Une nouvelle promotion à former\n\nLe Programme Supérieur de Spécialisation en Finances Publiques (PSSFP) lance officiellement la **14e promotion** de son Master Professionnel, sur communiqué conjoint du Ministre des Finances et du Recteur de l'Université de Yaoundé II-Soa.\n\n## Calendrier — Campagne P14\n\n- **27 juillet 2026** : ouverture des candidatures en ligne\n- **18 septembre 2026, 15h30** : clôture des candidatures\n- **Résultats** : publiés par communiqué conjoint du Ministre des Finances et du Recteur de l'UY2-Soa\n\n## Deux modalités\n\n- **Présentiel** — Campus de Messa, Yaoundé : 25 places par filière\n- **Formation à distance** : 10 places par filière\n\n## Conditions d'admission\n\n- **Diplôme universitaire de niveau BAC+3** en économie, gestion, droit ou discipline assimilée\n- Justifier d'une **expérience d'au moins 5 ans** dans un service ou une structure ayant un lien direct avec les Finances Publiques (VAE possible selon cohérence formation/projet professionnel)\n\n## Frais\n\n- **Frais de candidature** : 50 000 FCFA (non remboursables, payables en agence CREMINCAM)\n- **Master 1** : 1 185 000 FCFA / an\n- **Master 2** : 1 135 000 FCFA / an\n\n## Les 5 filières\n\n1. Économie Publique et Gestion Publique\n2. Fiscalité, Finance et Comptabilité Publique\n3. Gouvernance Territoriale et Finances Publiques locales\n4. Marchés Publics et Partenariats Public-Privés\n5. Audit et contrôle des Finances Publiques\n\n## Candidater\n\nLe dossier se constitue en ligne sur **[apply.pssfp.org](https://apply.pssfp.org)** : profil, photo d'identité et paiement CREMINCAM. Les pièces justificatives (diplôme, acte de naissance, relevés de notes, CV, lettre de motivation, attestation employeur le cas échéant) peuvent être ajoutées en ligne ou apportées au bureau de la scolarité (Yaoundé-Messa, porte 231).\n\n[Candidater maintenant →](https://apply.pssfp.org)",
            ],
            [

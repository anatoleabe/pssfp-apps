...
function fullProfilePayload(): array
{
    ...
    return [
        ...
        // dossier créé par ces tests est un dossier neuf, donc en v2. La
        // non-régression des dossiers antérieurs est couverte séparément par
        // DiplomeRequisTest (« laisse un dossier v1 soumissible… »).

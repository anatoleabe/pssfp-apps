...
it('ArticlesSeeder seeds the 4 new S5 articles validés par Anatole', function (): void {
    $this->seed(ArticlesSeeder::class);

    foreach ([
        'lancement-formations-continues-2026',
        'lancement-appel-candidature-promo-14',
        'formation-centre-pasteur-yaounde',
        'formation-assemblee-nationale-cameroun',
    ] as $slug) {
        expect(Article::query()->where('slug', $slug)->exists())
